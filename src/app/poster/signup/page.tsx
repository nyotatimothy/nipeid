    ...
    <Box sx={{ minHeight: "100vh", bgcolor: "background.default" }}>
      ...
      <Box sx={{ textAlign: "center", mt: 6, mb: 4 }}>
        ...
        <Typography variant="subtitle1" color="text.secondary">
          Register to upload found documents. Your account will require admin approval.
        </Typography>
      </Box>
      {/* Form Card */}
            ...
            {success ? (
              <Box display="flex" flexDirection="column" gap={2}>
                <Alert severity="success" sx={{ mb: 2 }}>
                  Registration successful! Your account is pending admin approval. You will be notified by email.
                </Alert>
              ...
              <Box display="flex" flexDirection="column" gap={2}>
                ...
                <Button color="primary" onClick={() => setForgot(false)} sx={{ textTransform: 'none' }}>Back to sign up</Button>
              </Box>
            ) : (
